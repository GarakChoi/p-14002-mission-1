...
class ApiV1PostCommentController(
    ...
    fun getItems(
        ...
        val post: Post = postService.findById(postId) ?: throw NoSuchElementException("Post not found")
    ...
    fun getItem(
        ...
        val post: Post = postService.findById(postId) ?: throw NoSuchElementException("Post not found")
        val postComment: PostComment = post.findCommentById(id) ?: throw NoSuchElementException("Comment not found")
