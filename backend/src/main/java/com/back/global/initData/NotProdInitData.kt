...
class NotProdInitData(
    ...
    fun work2() {
        ...
        val memberUser1 = memberService.findByUsername("user1")?: throw NoSuchElementException()
        val memberUser2 = memberService.findByUsername("user2")?: throw NoSuchElementException()
        val memberUser3 = memberService.findByUsername("user3")?: throw NoSuchElementException()
